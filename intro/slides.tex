...
\begin{frame}{Algo sobre mi}
    \begin{itemize}
        ...
        \item Más de 20 años programando (y enseñando) \textbf{Python}.
...
\begin{frame}{Módulo: Programación}
    \begin{itemize}
        ...
        \item Aula virtual CAMPUS: \link[https://peq.es/pro]{peq.es/pro}
        \item Contenidos: \link[https://peq.es/python]{peq.es/python}
...
\begin{frame}{Entregables}
    \begin{tabular}{|l|l|l|l|l|}
        ...
        UT7 & \ding{51} &\ding{51} &           & \\
        \hline
        UT8 & \ding{51} &\ding{51} & \ding{51} & \ding{51}\\
        \hline
    \end{tabular}
\end{frame}
...
\begin{frame}{Horario}
    \begin{tabular}{|l|l|l|l|l|l|}
        ...
        \hline        
        14:30 - 15:25 & & \textcolor{purple}{PRO} & & &\\
        \hline
        15:25 - 16:20 & \textcolor{purple}{PRO} & \textcolor{purple}{PRO} & & &\\
        \hline
        ...
        17:45 - 18:40 & & & & &\\
        \hline
        18:40 - 19:35 & & & & \textcolor{purple}{PRO} &\\
        \hline
        19:35 - 20:30 & & & & \textcolor{purple}{PRO} &\\
        \hline
    \end{tabular}
\end{frame}
