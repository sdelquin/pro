...
sudo apt install -y vim curl git tree xclip fonts-powerline fonts-firacode psmisc autocutsel materia-gtk-theme papirus-icon-theme zip fonts-noto-color-emoji
